...
namespace SIS.Application.DTOs.CourseInstance
{
    /// <summary>
    /// Represents the data transfer object for retrieving course offering details.
    /// </summary>
    public class CourseInstanceGetDto
    {
        /// <summary>
