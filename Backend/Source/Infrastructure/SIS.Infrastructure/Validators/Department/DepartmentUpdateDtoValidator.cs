...
{
    /// <summary>
    /// Validator for the <see cref="DepartmentUpdateDto"/> class.
    /// Ensures that the data provided for updating a department meets the required rules and constraints.
    /// </summary>
    public class DepartmentUpdateDtoValidator : AbstractValidator<DepartmentUpdateDto>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DepartmentUpdateDtoValidator"/> class.
        /// </summary>
        /// <param name="departmentValidator">An instance of <see cref="IDepartmentValidator"/> to perform custom validation logic.</param>

        public DepartmentUpdateDtoValidator(IDepartmentValidator departmentValidator)
        {
